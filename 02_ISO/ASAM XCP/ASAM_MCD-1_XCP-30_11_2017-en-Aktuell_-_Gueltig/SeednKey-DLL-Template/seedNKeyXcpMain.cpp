...
static TXcpSkExtFncRet computeKeyFromSeedDbg(BYTE byteLenSeed, BYTE *seed, BYTE *key);
                                                       ...
                                                       BYTE *byteLenKey, BYTE *key)
{
   ...
   *byteLenKey = byteLenSeed; // assumption: same length for seed and key
   ...
   case  XcpSkPrivDbg:    return computeKeyFromSeedDbg(byteLenSeed, seed, key);
...
//*****************************************************************************
/// @fn   computeKeyFromSeedDbg ... algorithm for Debugging access
//*****************************************************************************
static TXcpSkExtFncRet computeKeyFromSeedDbg(BYTE byteLenSeed, BYTE *seed, BYTE *key)
{
   BYTE i;
